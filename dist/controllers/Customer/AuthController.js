...
class AuthController {
    ...
    async forgot(req, res) {
        ...
        const link = `https://localhost:3000/resetPassword/${user === null || user === void 0 ? void 0 : user.id}/${token}`;
    ...
    async reset(req, res) {
        ...
        if (isValid && expire) {
            ...
            const newPassword = await userRepository_1.userRepository.create({
                ...user,
                password: hashPassword,
            });
            await userRepository_1.userRepository.merge(user, newPassword);
            const data = await userRepository_1.userRepository.save(user);
            console.log(data);
